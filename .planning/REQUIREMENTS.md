...
- [ ] **POC-01**: `npx wingman` starts a Node.js HTTP/WebSocket server and opens a browser window automatically
- [ ] **POC-02**: Browser window renders a terminal using xterm.js connected to the server via WebSocket
...
- [ ] **POC-08**: ANSI colours, spinners, and formatting render correctly in browser terminal
- [ ] **POC-09**: Terminal history is scrollable in browser
