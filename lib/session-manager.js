...
class SessionManager {
  ...
  // Register a newly spawned PTY process as a session
  ...
  // Mark session as closed and update disk
  ...
  // Write metadata to disk (atomic): id, createdAt, closed only (ptyProcess is memory-only)
  updateSessionsFile() {
